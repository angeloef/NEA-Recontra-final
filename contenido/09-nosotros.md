...
**Archivo:** `site/nosotros/index.html`
...
| Campo | Contenido |
|---|---|
| `<title>` | Nosotros — NEA Sistemas \| Oberá, Misiones |
| `description` | Quiénes somos, cómo trabajamos y con qué negocios sí y con cuáles no. Mostramos el trabajo antes de cobrar, el diagnóstico es gratis y todo queda a tu nombre. |
| `canonical` | https://neasistemas.com.ar/nosotros/ |
| `og:title` / `twitter:title` | Nosotros — NEA Sistemas |
| `og:description` / `twitter:description` | Cómo trabajamos, con quién sí y con quién no, y por qué mostramos el trabajo antes de cobrar. |

### Datos estructurados

**ProfessionalService:** *Estudio de diseño web, posicionamiento, campañas y sistemas a medida con base en Oberá, Misiones. Trabaja con negocios de toda la Argentina de forma remota.*

**AboutPage:** *Quiénes somos, cómo trabajamos y con qué tipo de negocios trabajamos y con cuáles no.*
...
- Menú de la página: Cómo trabajamos · Para quién sí y para quién no · Las cuatro etapas · Nuestras reglas · Preguntas
...
**Miga de pan:** Inicio → Nosotros

**H1:** Somos nuevos. Por eso *mostramos* antes de cobrar.
...
**Botones:** Pedí tu diagnóstico gratis · Mirá si somos para vos
...
**H2:** Cada regla rara que tenemos salió de una desconfianza razonable.
...
### 01 · Mostramos el trabajo antes de cobrarlo
...
### 02 · El diagnóstico es gratis y viene con precios adentro
...
**H2:** No trabajamos con cualquiera, y preferimos decirlo acá.
...
*La columna de la izquierda no es un insulto: son proyectos legítimos que otro va a resolver mejor que nosotros.*
...
## CÓMO SE ENCADENA EL TRABAJO

**H2:** Cuatro etapas en orden. Cada una fabrica el insumo de la siguiente.
...
### 01 · Web — el lugar donde se decide
...
*Enlaces:* Ver cómo hacemos las webs · Tienda online

### 02 · SEO — que te encuentren sin pagar el clic
...
### 03 · Ads — acelerar lo que ya funciona
...
*Enlace:* Ver SEO y campañas

### 04 · Sistemas — que la operación no te coma
...
**H2:** Seis compromisos que preferimos dejar por escrito.
...
| **Podés frenar al final de cualquier etapa** | Sin permanencia y sin penalidad. Cada etapa termina en algo terminado que te llevás, no en una pieza a medio hacer. |
| **Te decimos cuando no hace falta** | Si con un ajuste chico alcanza, o si lo que pedís es caro y no te va a mover el número, lo decimos. Vender de más una vez cuesta un cliente para siempre. |

---

## DÓNDE ESTAMOS

**H2:** En Oberá, Misiones. Trabajando con todo el país.
...
**Pie de imagen:** La primera etapa se parece más a esto que a una pantalla de código: leer cómo funciona el negocio, mirar a los competidores y escribir qué conviene hacer primero. Recién después se elige la tecnología. *Imagen ilustrativa.*
*(alt: Vista cenital de una mesa de trabajo con libros abiertos, papeles anotados y varias manos escribiendo)*

**Enlace:** Ver la galería de trabajos

---

## LO QUE TODAVÍA NO TENEMOS

**H2:** Recién empezamos. Te contamos qué significa eso para vos.
...
### 01 · No tenemos cien casos ni testimonios de vitrina
...
### 02 · Atendés directo con quien hace el trabajo
...
### 03 · Tu proyecto no es uno más en la fila
...
### 04 · Nos conviene mucho que te salga bien
...
**H2:** Lo que nos preguntan antes de decidirse.
...
**H2:** La forma más rápida de saber si somos para vos.
...
- Hola, leí la página de nosotros y quiero el diagnóstico gratis
